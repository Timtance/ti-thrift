...
var ttypes = require("../gen-nodejs/tutorial_types.js");
var SharedStruct = require("../gen-nodejs/shared_types.js").SharedStruct;
...
server.on('listening', function() {
  ...
  console.log(`服务端: connection localhost ${port}` + new Date().toString());
});
server.listen(port);